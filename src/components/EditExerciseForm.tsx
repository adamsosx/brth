...
export default function EditExerciseForm({ exerciseId }: { exerciseId: string }) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex gap-4">
        <button
          type="button"
          onClick={() => router.push('/')}
          className="flex-1 bg-white/10 text-white px-6 py-3 rounded-xl font-medium 
        ...
        <button
          type="submit"
          className="flex-1 bg-ocean-500 text-white px-6 py-3 rounded-xl font-medium 
